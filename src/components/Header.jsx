    ...
    <header className="sticky top-0 z-40 bg-brand-black border-b border-brand-gray-mid">
      <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-brand-red rounded-xl flex items-center justify-center text-xl shadow-red-glow">
            🌭
          </div>
          <div>
            <h1 className="font-display font-black text-white text-xl leading-none">
              Dog<span className="text-brand-yellow">House</span>
            </h1>
            <p className="text-xs text-gray-400 leading-none mt-0.5">Hot Dogs & Street Food</p>
          </div>
        </div>
